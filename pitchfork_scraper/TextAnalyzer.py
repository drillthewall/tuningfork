...
#         nonexistent[word] = times
#     else:
#         english_words[word] = times
...
f1 = open('every_word_sorted.txt','w',encoding="utf-8")
print(*every_word_sorted,sep = "\n",file=f1)
f2 = open('delta_sorted.txt','w',encoding="utf-8")
print(*delta_sorted,sep = "\n",file=f2)
f3 = open('exclusive_words_sorted.txt','w',encoding="utf-8")
